...
async function aplicarTodosParametros() {
  ...
  // Salva UMA POR UMA, exatamente como o botão individual (que funciona),
  // esperando cada gravação terminar antes de ir pra próxima.
  ...
  // Feedback garantido por alert
  if (falhas.length === 0) {
    alert('✅ ' + okCount + ' cultura(s) salvas no sistema!\n\nContinuam salvas mesmo ao fechar ou atualizar a página.');
  } else {
    alert('Salvas: ' + okCount + '\nFalharam: ' + falhas.length +
